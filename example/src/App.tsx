  ...
  return (
    <>
      <Selector
        ...
        // you can pass a custom options to IOS picker here docuement in start of this file
        // pickerOptionsIos={{}}
        stylePicker={{}}
      ...
      <CustomSelector
        selectedValue={multiBox}
        onChange={(value) => setmultiBox(value)}
        fullArray={multiBoxArray}
        mode="dropdown"
        forceIOSModal={true}
      />
    </>
